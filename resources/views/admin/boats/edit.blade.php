...
<div class="container p-3 shadow-sm mb-5 rounded" style="background-color: #FFFFFF;">
    ...
    <div class="d-flex justify-content-center">
        We could not find the boat,sorry!
    </div>
    ...
    <div class="row my-2 mx-1 justify-content-center position-relative">
        ...
        <div class="col-lg-5 my-2 col-md-10 col-sm-10 col-xs-12 col-content p-2 offset-lg-1 offset-md-0 offset-sm-0 offset-xs-0">
            <!-- Update form for boat data -->
            <form action="{{ action( 'AdminBoatsController@update', [ 'id' => $boat->id ] ) }}" method="POST">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <input type="number" class="form-control" name="limit" value="{{ $boat->limit }}" id="limit" min="1" max="20" placeholder="1">
                </div>
            </div>
            <!-- -->
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <p class="font-weight-bold">Name of the Boat</p>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <input type="text" class="form-control" name="limit" value="{{ $boat->name }}" id="limit" min="2" max="20" placeholder="1">
                </div>
            </div>
            <!-- -->
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <select class="form-control" name="status" id="status">
                        <option value="1"{{ !$boat->trashed() ? "selected" : ""}}>Active</option>
                        <option value="0" {{ $boat->trashed() ? "selected" : ""}}>Disabled</option>
                    </select>
                </div>
            </div>
            <!-- -->
