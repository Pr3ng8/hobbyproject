...
@foreach($post->comments as $comment)
  ...
  <li class="media my-4">
    ...
    <img class="mr-3 img-comment" src="{{ empty($comment->user->photos['file']) ? 'https://via.placeholder.com/64x64' : asset($comment->user->photos['file'])  }}" alt="Generic placeholder image">
